            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (!empty($ttd['img'])): ?>
                            <img src="<?= $ttd['img']; ?>" alt="Images" width="200px" height="200px"><br>
                            <a href="<?= base_url(); ?>Signature" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2">
                                <i class="fas fa-download fa-sm text-white-50"></i> Tambah Tanda Tangan
                            </a>
                            <a href="<?= base_url(); ?>Signature/hapus/<?= $ttd['id']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm mt-2">
                                <i class="fas fa-download fa-sm text-white-50"></i> Hapus Tanda Tangan
                            </a>
                        <?php else: ?>
                            <p class="text-danger">Silahkan masukkan tanda tangan anda</p>
                            <a href="<?= base_url(); ?>Signature" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-2">
                                <i class="fas fa-download fa-sm text-white-50"></i> Tambah Tanda Tangan
                            </a>
                        <?php endif; ?>
